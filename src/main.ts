...
async function boot(): Promise<void> {
  ...
  const game = new Phaser.Game({
    ...
    scene: [HubScene, ColorSortScene, ItemSortScene, ItemMatchScene, LetterMatchScene, FindLetterScene, ListenFindScene, ShapeSortScene, SizeSortScene, ShapeMatchScene, CaseMatchScene, FindColorScene, FindShapeScene, AnimalSoundScene, CountingScene, PatternsScene, FirstLetterScene],
  });
